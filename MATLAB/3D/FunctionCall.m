...
y_max = x_max;
z_max = x_max;
obstacle = zeros(x_max, y_max, z_max);
...
obstacle(301:500, 1:800, 1:800) = 1;
obstacle(601:800, 301:1000, 301:1000) = 1;


[route, init_n, init_cost, final_cost] = RRTStar_SmartFN_3D (numIterate, maxNodes, x_max, y_max, z_max, obstacle, q_start, q_goal, b);
disp(final_cost);
